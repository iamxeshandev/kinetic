...
namespace kinetic_api.Migrations
{
    ...
    [Migration("20260924131110_Migration4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("kinetic_api.Models.TaskLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("kinetic_api.Models.TaskType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("kinetic_api.Models.Task", b =>
                {
                    ...
                    b.HasOne("kinetic_api.Models.TaskType", "TaskType")
                        .WithMany()
            ...
            modelBuilder.Entity("kinetic_api.Models.TaskLabel", b =>
                {
                    ...
                    b.HasOne("kinetic_api.Models.Task", null)
                        .WithMany("TaskLabels")
                        .HasForeignKey("TaskId");
